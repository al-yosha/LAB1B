...
TEST(NephroidMethods, Coordinates) {
	lab1b::Nephroid a1;
	const double PI = 3.14159, err = 0.0001;
...
TEST(NephroidMethods, Curveradius) {
	lab1b::Nephroid a1;
	const double PI = 3.14159, err = 0.0001;
...
TEST(NephroidMethods, Area) {
	lab1b::Nephroid a1;
	const double PI = 3.1415, err = 0.0001;
	ASSERT_EQ(12 * PI, a1.area());
	lab1b::Nephroid a2(1, 3, 2);
	ASSERT_EQ(48 * PI, a2.area());
}
